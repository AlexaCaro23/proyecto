document.addEventListener('DOMContentLoaded',()=>{ //listener: escuchador de un evento //contentloaded: cuando el navegador ya esta cargado
    ...
    function getProducts() {
        ...
        //fetch: promesa, tienen dos estados resulta o rechazada
        //resuelta: then - la peticion esta aceptada
        //catch: rechazada -
        //arrray: conexion de diferentes datos
    ...
    function showProducts(products) {
        tabla.innerHTML = " ";
        products.forEach(product => { //metodos de array, forEach: no crea un nuevo array, match: si crea un nuevo arra, son: devuelve un booleano
            ...
            `;
        tabla.appendChild(row); //appenchild pasar un elemento ccualquiera al html
    ...
    function eliminarProducto(e) {
        const id = parseInt(e.target.getAttribute('data-id')); //parseint: convertir un dato a entero
        console.log(id);
        Swal.fire({
        ...
        //promesa: objeto de una operacion asincrona 
        .then(result=>{
    ...
    function cleanField(){ //const: no cambia, let: puede cambiar, bard
